...
# Must be provided via environment variable (no hardcoded fallback)
...
# URL configuration pointing to the project's URL dispatcher
ROOT_URLCONF = 'projeto.urls'

# Template configuration for rendering HTML templates, with context processors for authentication and messages
TEMPLATES = [
    {
